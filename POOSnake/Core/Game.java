...
public class Game {
    ...
    // Constructor
    public Game(int arenaDimensionsX, int arenaDimensionsY, Ponto foodPosition, Color foodColor, Food.FoodType foodType,
            int headDimensions, String rasterization, int score, List<Obstacle> obstacles, String interfaceMode) {
